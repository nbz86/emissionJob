...
ROOT_PATH='/media/burak/yedek/emission_job/external_data'
FASTA_DATA_PATH=os.path.join(ROOT_PATH,'uniclust50_2018_08')
...
WAVELENGTH_DB_DATA_PATH=os.path.join(WAVELENGTH_DB_ROOT,'db')
SPECTRUM_IMAGES_PATH=os.path.join(WAVELENGTH_DB_ROOT,'png_files')
